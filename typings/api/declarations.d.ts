type SummitLearningISODate = `${number}-${number}-${number}`;
...
interface SummitLearningProjectAssignmentsByProject {
  ...
  projectId: number;
  startDate: SummitLearningISODate;
  dueOn: SummitLearningISODate;
  studentId: number;
  overdue: boolean;
  submittedOn: SummitLearningISODate | null;
  updatedAt: string;
}
...
interface SummitLearningSites {
  ...
  schoolEnd: SummitLearningISODate;
  schoolEndYear: number;
  schoolStart: SummitLearningISODate;
