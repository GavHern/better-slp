type SummitLearningAPIDate = `${number}-${number}-${number}`;
...
interface SummitLearningProjectAssignmentsByProject {
  ...
  "projectId": number;
  "startDate": SummitLearningAPIDate;
  "dueOn": SummitLearningAPIDate;
  "studentId": number;
  "overdue": boolean;
  "submittedOn": SummitLearningAPIDate | null;
  "updatedAt": string;
}
...
interface SummitLearningSites {
  ...
  "schoolEnd": SummitLearningAPIDate;
  "schoolEndYear": number;
  "schoolStart": SummitLearningAPIDate;
