...
},{}],"components/TestComponent.svelte":[function(require,module,exports) {
"use strict";
...
var file = "components/TestComponent.svelte";
...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      /*myVar*/
      ctx[0]);
      (0, _internal.add_location)(p, file, 4, 0, 65);
    },
...
function instance($$self, $$props, $$invalidate) {
  var _$$props$$$slots = $$props.$$slots,
      ...
      $$scope = $$props.$$scope;
  (0, _internal.validate_slots)("TestComponent", slots, []);
  "use strict";

  var myVar = "hi";
  var writable_props = [];
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<TestComponent> was created with unknown prop '".concat(key, "'"));
  });
  ...
  $$self.$inject_state = function ($$props) {
    if ("myVar" in $$props) $$invalidate(0, myVar = $$props.myVar);
  };
...
var TestComponent = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(TestComponent, _SvelteComponentDev);
...
var TestComponent_svelte_1 = __importDefault(require("../components/TestComponent.svelte"));
...
function createGPAElement(gpa) {
  ...
  var gpaText = document.createElement('span');
...
function appendGPAEstimate() {
  ...
  var gpaAverageElement = createGPAElement(gpa);
  (_document$querySelect = document.querySelector('.sdl-course-grades')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.appendChild(gpaAverageElement);
  new TestComponent_svelte_1.default({
    target: document.getElementsByClassName('better-slp-gpa-estimate')[0]
  });
}

exports.appendGPAEstimate = appendGPAEstimate;
},{"./data":"modules/data.ts","./methods":"modules/methods.ts","../components/TestComponent.svelte":"components/TestComponent.svelte"}],"inject.ts":[function(require,module,exports) {
"use strict";
